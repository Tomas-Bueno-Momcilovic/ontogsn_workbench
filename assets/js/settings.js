...
import { resolveEl, escapeHtml, downloadText, mountTemplate } from "./utils.js";

const HTML = new URL("../html/settings.html", import.meta.url);
const CSS  = new URL("../css/settings.css", import.meta.url);
