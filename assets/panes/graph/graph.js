...
import { mountTemplate, resolveEl, addToSetMap, uid, splitTokens, exposeForDebug } from "@core/utils.js";
...
const HTML = new URL("./graph.html", import.meta.url);
const CSS = new URL("./graph.css", import.meta.url);
